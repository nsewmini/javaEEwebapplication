...
<%@page import="java.util.List"%>    
        ...
        for(model.flightinfobean e:list){  
            out.print("<tr><td>"+"&nbsp "+e.getflightid()+"</td><td>"+"&nbsp"+e.getflightfrom()+"</td><td>"+"&nbsp"+e.getflightto()+"</td><td>"+"&nbsp"+e.getdepartdate()+"</td><td>"+"&nbsp"+e.getreturndate()+"</td><td>"+"&nbsp"+e.gettime()+"</td><td> <form action='book_a_flight.jsp' method='post'><input type='hidden' name='' value="+e.getflightid()+"> <input type='submit' value='Book' class='bookBtn'></form></td></tr>");  
        }  
        ...
        for(model.flightinfobean e:list){  
         out.print("<tr><td>"+"&nbsp "+e.getflightid()+"</td><td>"+"&nbsp"+e.getflightfrom()+"</td><td>"+"&nbsp"+e.getflightto()+"</td><td>"+"&nbsp"+e.getdepartdate()+"</td><td>"+"&nbsp"+e.gettime()+"</td><td> <form action='book_a_flight.jsp' method='post'><input type='hidden' name='' value="+e.getflightid()+"> <input type='submit' value='Book' id='f4' class='bookBtn'></form></td></tr>");  
        }  
        /*<form action='./movestafftog2' method='post'><input type='hidden' name='username' value="+e.getuname()+"> <input type='submit' value='Grade 02'>  </form>*/
